...
- 2026-03-10: pure CBOR-only transport re-proven live on A17 (DEVICE_B) and S23 (DEVICE_A); MTU 185->517; HELLO 29 bytes; REPLY 133 bytes; PP_VERIFY true/true; PP_TICKET GENERATED; PIPE_LEDGER_CREDIT; PIPE_UI_REFRESH.
...
- RUN_020: stable reward peer identity proven at app layer; rotating BLE MACs no longer create duplicate rewarded peers.
